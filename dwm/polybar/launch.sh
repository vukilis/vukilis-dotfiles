...
CONFIG_FILE="$HOME/.local/share/dwm-vukilis/polybar/themes/$THEME/config.ini"
LAPTOP_CONFIG_FILE="$HOME/.local/share/dwm-vukilis/polybar/themes/$THEME/laptop-config.ini"
